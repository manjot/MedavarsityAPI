			...
			<div class="page-content">
				...
				<div class="page-bar">
					<ul class="page-breadcrumb">
						...
						<li>
							<a href="<?php echo site_url('Superadmin/facultyList')?>">Admin Detail</a>
						</li>
					</ul>
					...
					<div class="col-md-12">
						<div class="profile-sidebar" style="width:250px;">
							<div class="portlet light profile-sidebar-portlet">
								...
								$facultyImg=$result['facultyDetail']['profile_image_url'];
								if($facultyImg)
								{
									$imgurl=base_url().'assets/images/faculty/'.$facultyImg;
								}else{
									$imgurl='http://healthoptim.com/profilepicture/avatar.png';
								}
								?>
							<img src="<?php echo $imgurl; ?>" class="img-responsive" alt="">
								...
								<div class="profile-usertitle">
									<div class="profile-usertitle-name">
										<?php echo ucfirst($result['facultyDetail']['name']);?>
									</div>
								</div>
