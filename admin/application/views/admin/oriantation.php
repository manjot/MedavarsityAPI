								...
								<div class="tab-pane active" id="tab_0">
									...
									<div class="portlet box yellow">
										<div class="portlet-title">
											<div class="caption">
												<i class="fa fa-gift"></i>Add Orientation and Motivations Video
											</div>
										</div>
										<div class="portlet-body form">
											<!-- BEGIN FORM-->
						<form action="<?php echo site_url('Superadmin/addoriantVideoUrl')?>" method="post" class="form-horizontal" name="">
