								...
								<div class="tab-pane active" id="tab_0">
									...
									<div class="portlet box yellow">
										...
										<div class="portlet-body form">
											<!-- BEGIN FORM-->
						<form action="<?php echo site_url('Medi_varsity/addVideoUrl')?>" method="post" class="form-horizontal" name="">
											...
											<a href="<?php echo site_url('Medi_varsity/facultyList')?>" type="button" class="btn red">Cancel</a>
