...
{
	$userLogin=$this->session->userdata('admin_id');
}else{
	$userLogin=$this->session->userdata('faculty_id');
}
if(empty($userLogin))
{
	redirect('loginpanel');
...
<head>
<meta charset="utf-8"/>
<title>Medivarsity | User Dashboard </title>
...
<div class="page-header navbar navbar-fixed-top">
	...
	<div class="page-header-inner container">
		...
		<div class="page-logo">
			...
			<h3 style="color:white">Medivarsity</h3>
			...
			<div class="top-menu">
				<ul class="nav navbar-nav pull-right">
					...
					<li class="dropdown dropdown-extended dropdown-notification" id="header_notification_bar">
						<!-- <a href="postlist.html" class="dropdown-toggle">
						<i class="icon-bell"></i>
					...
					<li class="dropdown dropdown-user">
						...
						<ul class="dropdown-menu dropdown-menu-default">
							<li>
								<a href="<?php echo base_url('Superadmin/facultyDetail/'.$result['getadmindetail']->user_id);?>">
								<i class="icon-user"></i> My Profile </a>
							</li>
<li class="divider">
							</li>
								<li>
								<a href="<?php echo site_url('Superadmin/changepassword');?>">
