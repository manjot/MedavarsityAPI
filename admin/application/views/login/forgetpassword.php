...
<div class="content">
	...
	<form class="login-form" action="<?php echo base_url();?>MedivarsityLogin/send_password" method="post">
		<h3 class="form-title">Forget Password</h3> 
        <?php print $this->session->flashdata('email_error'); ?></span>
        <?php print $this->session->flashdata('email_success'); ?></span>

		<div class="form-group">
			<label class="control-label visible-ie8 visible-ie9">Email</label>
			<div class="input-icon">
				<i class="fa fa-user"></i>
				<input class="form-control form-control-solid placeholder-no-fix" type="text" autocomplete="off" placeholder="Email" id="useremail" name="useremail"/>
			</div>
			<span id="erroremail"></span>
		</div>
		
		<div class="form-actions">
           <a href="<?php echo base_url();?>" style="color: #e1eef7;" class="forget-password btn btn-primary">Back</a>
			<button type="submit" class="btn blue pull-right btn-forget">
